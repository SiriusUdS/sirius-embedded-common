...
#define HBL388_OPENED_DUTY_CYCLE_CCR ((uint32_t)HBL388_ARR * (uint32_t)HBL388_PWM_OPENED_DUTY_CYCLE_PCT) / (uint32_t)100 
#define HBL388_CLOSED_DUTY_CYCLE_CCR ((uint32_t)HBL388_ARR * (uint32_t)HBL388_PWM_CLOSED_DUTY_CYCLE_PCT) / (uint32_t)100
